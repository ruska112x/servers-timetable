...
public class TeachersController {
    ...
    @PostMapping
    public long addTeacher(@Valid @RequestBody AddTeacher addTeacher) {
        return teachersService.addTeacher(addTeacher);
    }

    @PutMapping
    public String editTeacher(@Valid @RequestBody Teacher teacher) {
